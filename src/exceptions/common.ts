...
export const USER_DENIED_TRANSACTION_SIGNATURE_ERR =
  "User denied transaction signature";
export const INSUFFICIENT_ORDERS_TO_FILL_AMOUNT_ERR =
...
export const INSUFFICIENT_ETH_BALANCE_FOR_DEPOSIT =
